...
<html>
   ...
   <body>
      <div class="menu">
         ...
         <div class="errorr">   <p class="redalert"> Forma nu a fost completată sau a apărut o eroare. </p> </div>
      </div>
      <?php
         $varinat1 = "";
         ...
         if (empty($_POST["variant"])) {
          $varinatErr = "*";
             ...
             $varinat = TRUE;  
             $varinat = "";
             $varinat = test_input($_POST["variant"]);
          }
      ...
      <div class="form2">
         ...
         <p class="text3"> Utilizatorul: 
            ...
            <br>
           <a class="link" href="..\PHP\report.php">  
               Apasă click pentru a te reântoarece la formă. </a>
      ...
      <div class="form1">
         ...
         <form id="basic-form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            <p class="text"> Numele utilizatorului :
               <input class="name" type="text" name="name" value="<?php echo $name;?>" required/>
               <span class="error">
               <?php echo $nameErr;?>
               </span> 
            </p>
            ...
            <p class="radio ">
               <input type="radio" name="variant" <?php if (isset($varinat) && $varinat=="Spam" ) ?> value="Spam"  required/> Spam
               <br>
               <input type="radio" name="variant" <?php if (isset($varinat) && $varinat=="Cont furat" ) ?>value="Cont furat" required/> Cont furat
               <br>
               <input type="radio" name="variant" <?php if (isset($varinat) && $varinat=="Alt motiv" ) ?> value = "Alt motiv" required/> Alt motiv
            </p>
